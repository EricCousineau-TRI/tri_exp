...
load("@drake//tools:python.bzl", "python_repository")
...
load("@drake//tools:numpy.bzl", "numpy_repository")
...
load("@drake//tools:mosek.bzl", "mosek_repository")

mosek_repository(
    name = "mosek",
)

load("@drake//tools:gfortran.bzl", "gfortran_repository")
...
# Python Libraries
load("@drake//tools:pypi.bzl", "pypi_archive")
...
load("@drake//tools:expat.bzl", "expat_repository")
...
load("@drake//tools:zlib.bzl", "zlib_repository")

zlib_repository(
    name = "zlib",
)

load("@drake//tools:drake_visualizer.bzl", "drake_visualizer_repository")
