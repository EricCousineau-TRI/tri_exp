...
// This class integrates perception algorithm, device interface with robot
// controller.
class HandEye {
 public:
  ...
  void SetEyeTransformationWrtHandFrame(Eigen::Isometry3d tf_eye_wrt_hand);
	...
	void MoveCameraToCartesianPose(Eigen::Isometry3d tgt_pose, double duration = 2.0);
	void MoveHandToCartesianPose(Eigen::Isometry3d tgt_pose, double duration = 2.0);
 ...
 private:
 	...
 	void MoveEECartesianStraightLine(Eigen::Isometry3d tgt_pose_ee, double duration = 2.0);
